...
def run_random_forest_gridsearch(X_train, y_train, X_test, y_test, horizon_index=1):
    X_train_flat = X_train.reshape(X_train.shape[0], -1)
    X_test_flat = X_test.reshape(X_test.shape[0], -1)
    ...
    grid_search.fit(X_train_flat, y_train_h)
    ...
    return grid_search.best_params_, test_acc
