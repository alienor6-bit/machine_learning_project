...
def main():
    ...
    lr_acc = run_logistic_regression(X_train_norm, y_train, X_test_norm, y_test, horizon_index=1)
    results_comparison['Logistic Regression'] = lr_acc
    
    # Model 2: Random Forest
    rf_acc, feature_importance = run_random_forest(X_train_norm, y_train, X_test_norm, y_test, horizon_index=1)
    results_comparison['Random Forest'] = rf_acc
    
    # Model 3: XGBoost
    xgb_acc = run_xgboost(X_train_norm, y_train, X_test_norm, y_test, horizon_index=1)
